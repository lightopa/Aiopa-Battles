...
mapFlags = None
levels = [{"name": "Fleeing Elria", "description": "With the castle fallen, you escape the city with a few loyal members of the Patrician's guard.", "style": "city", "friendly": False, "opName": "Demon Scouts", "pStart": False}]
