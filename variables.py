...
mapFlags = None
levels = [{"name": "Fleeing Elria", "description": "With the castle fallen, you escape the city with a few loyal members of the Patrician's guard.", "style": "city", "friendly": False, "opName": "Demon Scouts", "pStart": True}]
...
unid = 1 # The client's unid, generated by the server

opUnid = None # The opponent's unid, generated by the server 
opName = None # The opponent's name
opHealth = 20 # The opponent's health
opMana = 0 # The opponent's mana
opHand = [] # The opponent's hand
opDeck = [] # The oppontent's deck
